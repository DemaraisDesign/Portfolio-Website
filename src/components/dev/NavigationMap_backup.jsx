...
import { ArrowRight, ExternalLink, Hand, Clock } from "lucide-react";
...
const SECTIONS = [
    ...
    },
    {
        ...
        children: [
            { id: "writers-theatre", label: "Writer's Theatre", desc: "Audio Dramas", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774802925/1631371112504_rkyy1k.jpg" },
            { id: "a-christmas-carol", label: "A Christmas Carol", desc: "Broadcast Sound", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774451233/Screenshot_2026-03-25_at_10.06.51_AM_d3ezqv.png" },
            { id: "higherl", label: "HigherL", desc: "Interactive Audio", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774448918/Logo_No_Text_1_vgchkl.png", contain: true, imgScale: 1.4, imgNudge: { x: 2, y: 2 } },
            { id: "frozen-fluid", label: "Frozen Fluid", desc: "Live Sound Design", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774452020/Melting-Ice-Climate-Change-Concept-Art_hjsz7p.jpg" },
            { id: "take-with-water", label: "Take With Water", desc: "Film Audio", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774450795/images-1_msp631.jpg" },
            { id: "under-milkwood", label: "Under Milkwood", desc: "Live Sound Design", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1775165440/Gemini_Generated_Image_ymlnahymlnahymln_viquel.jpg" },
            { id: "she-kills-monsters", label: "She Kills Monsters", desc: "Live Sound Design", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774451516/Group_65_cjvm2n.png" },
            { id: "the-nomad-project", label: "The Nomad Project", desc: "Audio Dramas", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1775186682/nomad_j6cl80.png" },
        ],
    },
    {
        ...
        children: [
            ...
            { id: "redesigns", label: "Redesigns & Concepts", desc: "game audio", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1775492599/Screenshot_2026-04-06_at_9.50.34_AM_yqtrep.png" },
            { id: "surrija", label: "Project Surrija", desc: "Live XR", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1775585447/Gemini_Generated_Image_90up1q90up1q90up_mqrrl4.jpg" },
            { id: "ai-media", label: "Images, Video & Music", desc: "Media Experiments", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1775592998/tj2_fkyibp.png" },
        ],
    },
    {
        ...
        children: [
            ...
            { id: "still-app", label: "Still", desc: "App Concept", img: "https://res.cloudinary.com/dqabyzuzf/image/upload/f_auto,q_auto/v1774547046/Still_bananna_rzjxm0.png" },
                    ...
                    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                        {labelData.Icon ? (
                            ...
                            <img
                                ...
                                alt=""
                                style={{
                                    width: labelData?.contain ? '95%' : '100%',
                                    height: labelData?.contain ? '95%' : '100%',
                                    objectFit: labelData?.contain ? 'contain' : 'cover',
                                    objectPosition: labelData?.imgPosition || 'center',
                                    opacity: showIcon ? 1 : 0,
                                    transition: 'opacity 0.8s ease',
                                    transform: `${labelData?.imgScale ? `scale(${labelData.imgScale})` : ''} ${labelData?.imgNudge ? `translate(${labelData.imgNudge.x}px, ${labelData.imgNudge.y}px)` : (labelData?.contain ? 'translate(2px, -2px)' : '')}`.trim() || 'none'
                                }}
                            />
                        )}
                        ...
                        {labelData?.projectId && getProject(labelData.projectId)?.isConstruction ? (
                            <div style={{
                                ...
                                <svg style={{ width: '35%', height: '35%', opacity: 0.9 }} viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div style={{
                                ...
                                <svg style={{ width: '35%', height: '35%', opacity: 0.9 }} viewBox="0 0 24 24" fill="white" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function NavigationMap({ closeMenu }) {
    ...
    const isShortDesktop = viewport.h < 750 && viewport.w >= 768;
