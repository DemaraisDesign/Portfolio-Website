...
const STATEMENT_DATA = [
    ...
    {
        segments: [
            { text: "I look for the small touches that make an experience feel " },
            { text: "surprising and human", highlight: true },
            { text: " rather than merely functional." }
        ]
    },
    {
        segments: [
    ...
    return (
        <div ref={ref} className="relative w-8 h-8 md:w-10 md:h-10 shrink-0 mt-0 md:mt-1 mr-5 md:mr-8 flex items-center justify-center pointer-events-none">
            ...
            <motion.div 
                ...
                style={{ borderColor: 'rgba(86, 198, 255, 0.4)' }} // Light Screens Blue/Teal
            ...
            <motion.div 
                ...
                style={{ backgroundColor: BRAND_COLORS.screens }} // Brand Screens
                initial={{ scale: 0 }}
            ...
            <motion.div 
                ...
                style={{ backgroundColor: activeState ? '#FFFFFF' : BRAND_COLORS.screens }}
                initial={{ opacity: 0 }}
