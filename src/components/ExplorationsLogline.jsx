...
const STATEMENT_DATA = [
    {
        segments: [
            { text: "I believe that technology doesn't kill the human impulse to create. It" },
            { text: "redirects it", highlight: true },
            { text: "." }
        ]
    },
    {
        segments: [
            { text: "My practice starts with something human and uses AI to" },
            { text: "pressure test and iterate", highlight: true },
            { text: "." }
        ]
    },
    {
        segments: [
            { text: "I believe the obligation of this moment is to expand my capabilities, become more prolific, and" },
            { text: "direct the technology towards the betterment of the human condition", highlight: true },
            { text: "." }
        ]
    }
];
    ...
    return (
        <div ref={ref} className="relative w-8 h-8 md:w-10 md:h-10 shrink-0 mt-0 md:mt-1 mr-5 md:mr-8 flex items-center justify-center pointer-events-none">
            ...
            <motion.div 
                ...
                style={{ borderColor: 'rgba(255, 113, 91, 0.4)' }} // Light Brand Experiments Red
            ...
            <motion.div 
                ...
                style={{ backgroundColor: BRAND_COLORS.experiments }} 
                initial={{ scale: 0 }}
            ...
            <motion.div 
                ...
                style={{ backgroundColor: activeState ? '#FFFFFF' : BRAND_COLORS.experiments }}
                initial={{ opacity: 0 }}
...
export default ExplorationsLogline;
