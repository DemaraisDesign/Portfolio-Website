            ...
            <div>
              ...
              <motion.div className="space-y-6 text-brand-ink-body text-lg leading-relaxed mt-12" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-10%" }}>
                <motion.p variants={itemVariants}>
                  My career has been shaped by an acute case of intellectual wanderlust. It's almost compulsive. If I find a discipline that genuinely interests me and I have at least some natural aptitude for it, I have to learn it. What I didn't anticipate was how much these disciplines would end up interweaving with one another.
                </motion.p>
                <motion.p variants={itemVariants}>
                  The through line isn't a medium. It's a discipline I keep applying across every form I work in: <strong className="font-bold text-brand-ink">figure out what a project actually needs, remove the rest, and listen carefully—to the people making it happen, and to the people it's intended for.</strong>
                </motion.p>
                <motion.p variants={itemVariants}>
                  I built that discipline most profoundly at Coeurage Theatre Company, an exclusively pay-what-you-want theater I co-founded in Los Angeles. We competed for the same awards as companies with far greater resources, in one of the most expensive cities in the world…and won many of them. Stage & Cinema called me "the best director of his age in Los Angeles." <strong className="font-bold text-brand-ink">What those experiences actually gave me was more durable than any accolade: the habit of identifying what is essential to the storytelling, prioritizing resources toward those elements, and cutting anything extraneous without ego.</strong> We had all the artistic ambition in the world, but on our budgets there simply was no choice in the matter. And I wouldn't have had it any other way.
                </motion.p>
                <motion.p variants={itemVariants}>
                ...
                <motion.p variants={itemVariants}>
                  It also turns out that directing and UX research are essentially the same jobs wearing different clothes. Both require deep logistical preparation before you enter the room. Both require rigorous analysis to determine what someone actually needs beneath the surface of what they're saying. Both require listening with enough discipline to change course based on what participants reveal in their words and behavior. Both require synthesis across conflicting perspectives and the nerve to make decisions that won't satisfy everyone. The pipelines are nearly identical.
                </motion.p>
                <motion.p variants={itemVariants}>
                  Moving into UX gave that framework somewhere to reflect back. Backstage processes became a user experience. An audience's journey from parking lot to curtain became a user experience. The director's job of deciding what the story needs, what messages I want to convey, and ruthlessly subordinating every sonic and visual element to serve those purposes…sounds like information architecture to me. <strong className="font-bold text-brand-ink">Once I learned to think in terms of friction and cognitive load, I couldn't stop applying it to everything I do.</strong>
                </motion.p>
                <motion.p variants={itemVariants}>
