      ...
      <div className="w-full max-w-[1400px] mx-auto px-9 md:px-12 lg:px-24">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-16">
          <div className="w-full md:flex-1 order-2 md:order-1">
            <div>
              <h2 className="text-5xl md:text-7xl font-extrabold text-white font-outfit leading-tight tracking-wide uppercase">
...
const Works = () => {
  const projects = [
    ...
    getProject('arcworks-collective')
  ];
  ...
  return (
    <section ref={ref} id="works" className="bg-[#050508] text-white py-24 lg:py-32 overflow-hidden relative">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-9 md:px-12 lg:px-24 flex flex-col-reverse md:flex-row items-start justify-between mb-16 gap-12">
        <div>
          <h2
            ...
            className="text-5xl md:text-7xl font-extrabold text-white font-outfit uppercase tracking-tight mb-6 cursor-pointer hover:text-brand-orange transition-colors duration-300"
          >
            Explorations
          </h2>
          <p className="text-gray-400 font-light max-w-md md:max-w-2xl leading-relaxed text-lg text-left">
      ...
      <main className="relative">
        ...
        <div ref={heroRef} className="relative h-screen w-full overflow-hidden">
          ...
          <div className="absolute h-full top-0 left-0 w-full pointer-events-none z-10 flex items-center justify-start pl-6 md:pl-20">
            ...
            >
              <h1 className="font-outfit font-medium text-brand-ink tracking-tight mb-6 text-[clamp(3.5rem,10vmin,7rem)] leading-none">
                I'm Joseph Demarais.
              </h1>
